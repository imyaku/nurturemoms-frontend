    ...
    <section className="text-gray-600 body-font relative">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          <h1 className="sm:text-3xl text-2xl font-bold title-medium mb-4 text-gray-900">
            Contact Us
          </h1>
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <button className="flex mx-auto text-white bg-yellow-300 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-200 rounded text-lg">
                Submit
              </button>
            </div>
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a className="text-yellow-400">nurturemomsph@email.com</a>
              <p className="leading-normal my-5">Davao City, Philippines</p>
