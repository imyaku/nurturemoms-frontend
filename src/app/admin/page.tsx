    ...
    <body>
      ...
      <div className="sidebar fixed top-0 bottom-0 lg:left-0 p-2 lg:w-64 w-16 overflow-y-auto text-center bg-yellow-200">
        ...
        >
          ...
          <HiMiniUser size={18} />
          <span className="text-[15px] ml-2 font-bold">Approve Doctors</span>
        </div>
        ...
        >
          <i className="bi bi-bookmark-fill"></i>
          <HiMiniUser size={18} />
          <span className="text-[15px] ml-2 font-bold">Patients List</span>
        </div>
        ...
        >
          <i className="bi bi-bookmark-fill"></i>
          <HiMiniUser size={18} />
          <span className="text-[15px] ml-2 font-bold">Doctors List</span>
        </div>
        ...
        >
          ...
          <span className="text-[15px] ml-2 font-bold">FIle Manager</span>
        </div>
